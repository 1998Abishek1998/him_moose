        ...
        <section id="about">
            ...
            <div className="about-content">
                <div className="about-text">
                    <h3>Food with Himalayan Heritage</h3>
                    <p>
                    ...
                    <p> With over 25 years of culinary expertise, our chefs craft dishes that hit the perfect balance between familiar favorites and exotic flavors. From moose-inspired specials to smoky tandoori classics, every plate brings a story of cultures colliding — in the best way.
                    </p>
                    <p>
